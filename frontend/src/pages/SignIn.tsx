    ...
    <div className="min-h-screen flex w-full">
      ...
      <div className="hidden lg:flex w-1/2 bg-brand-950 relative overflow-hidden items-center justify-center">
        ...
        <div className="relative z-10 p-12 text-center max-w-lg">
          ...
          <h1 className="text-5xl font-bold text-white mb-6 tracking-tight">TaskForge</h1>
          <p className="text-xl text-brand-100 leading-relaxed">
            Manage your projects with elegance and efficiency. Join thousands of users who have transformed their workflow.
          </p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 relative">
        <div className="w-full max-w-md space-y-8">
          ...
          <p className="text-center text-gray-400 text-sm">
            ...
            <Link to="/sign-up" className="text-brand-400 hover:text-brand-300 font-medium hover:underline">
              Sign up for free
            </Link>
          </p>
        </div>
